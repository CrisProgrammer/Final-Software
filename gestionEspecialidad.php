...
<body>
    ...
    <img src="img/tecno.jpg" alt="" class="logo-danicodex">
        ...
        <ul class="cont-ul">
            ...
            <li><a href="verFichas.php?ci=<?php echo $carnet."&tipousuario=$tipousuario"?>">VER FICHAS</a></li>
    ...
    <h3>
        ...
        if ($result->num_rows > 0) {
            ...
            echo  $nombreUsuario."<script>
                    sessionStorage.setItem('patientName', '$nombreUsuario');
                    sessionStorage.setItem('patientCI', '$carnet');
                    sessionStorage.setItem('tipoUsuario', '$tipousuario');</script>";
        } else {
